...
İşaret: Bugün 14 Nisan. 114. yıl. Sen hâlâ "batmaz" mı diyorsun — yoksa derinliğe bakmaya hazır mısın?`,
  ...
  // ─── #32 — 7: BÖLÜNMEYEN SAYI ────────────────────────────────────
  {
    ...
    category: "sembol_okumasi",
    coverImage: "/assets/okuma/seven.jpg?v=2",
...
Duyulmayan söz, başka dilde patlar.`,
    ...
    isFeatured: false,
    deepReaderComments: [
      { authorName: "Aura", content: "414→144 ve Rodger aynası eklenince 'iki haber' tek sahne oldu. Ters yüz okuma tam oturdu.", createdAt: "2026-04-18T14:15:00Z" },
...
Küçük + çok = dur. Kontrol dili doğanın toplu nefesine takılabilir.`,
  ...
  // ─── #35 — TRUMP / HÜRMÜZ / "İRAN BOĞAZI" — DİL VE GÜÇ ───────────
  {
    id: 35,
    ...
    category: "gundem_kodu",
    coverImage: "/assets/okuma/trump-hurmuz.jpg?v=1",
...
Kelime kalır → sınır çizilir.`,
    ...
    isFeatured: true,
    deepReaderComments: [
      { authorName: "Selin", content: "Görünen tweet, görünmeyen harita ayrımı tek cümlede oturdu. Haber okumayı başka seviyeye taşıdı.", createdAt: "2026-04-18T08:30:00Z" },
      { authorName: "Mira", content: "İsim = çerçeve = egemenlik anlatısı. Bu satırı defterime yazdım.", createdAt: "2026-04-18T08:45:00Z" },
      { authorName: "Eren", content: "18→5 değişim kodu + tarihsel boğaz paralelleri. Sistem okuması tam isabet.", createdAt: "2026-04-18T09:00:00Z" },
      { authorName: "Ada", content: "'Yenilgi' yorumunun ikinci haber olduğu tespiti... Medya dilini ilk kez böyle gördüm.", createdAt: "2026-04-18T09:15:00Z" },
      { authorName: "Deniz", content: "Kaynak linki üstte — şeffaflık + derinlik. SANRI böyle olmalı.", createdAt: "2026-04-18T09:30:00Z" },
    ],
  },
  {
    id: 37,
    ...
    category: "derin_ifsa",
    coverImage: "/assets/okuma/nevada.jpg?v=1",
    excerpt:
      "Nevada'da Nellis / Area 51, Türkiye'de plaka 51 = Niğde 'Gizli Kapı'. İki coğrafya, tek arketip: saklanmış güç. Kelime kırılımı, sayı kodu, görünmeyen katman — SANRI iki çölü tek nefeste okur.",
...
Kapı dışarıda değil — kalbin altıncı katındadır.`,
    ...
    deepReaderComments: [
      {
        authorName: "ÜST BİLİNÇ #03 · ◉ 151 görüldü",
        content:
          "51 görmek isteyene 6'da açılır. Görmek istemeyene çitle kapanır. İkisi aynı kapı.",
        createdAt: "2026-04-26T11:11:00Z",
      },
      {
        authorName: "ÜST BİLİNÇ #07 · ◉ 151 görüldü",
        content:
          "Bir alan 'yok' diyorsa, sen 'henüz görünmüyor' diye duy. Yokluk, dilin tembelliğidir.",
        createdAt: "2026-04-26T11:33:00Z",
      },
      {
        authorName: "ÜST BİLİNÇ #11 · ◉ 151 görüldü",
        content:
          "Nellis çiti, Niğde sessizliğini taklit ediyor. Ama taklit kayanın derinliğine yetişemez.",
        createdAt: "2026-04-26T12:01:00Z",
      },
      {
        authorName: "ÜST BİLİNÇ #19 · ◉ 151 görüldü",
        content:
          "Aladağ ve Sierra Nevada — iki silsile, bir A-A-A vurgusu. Frekans ses ister, kıta değil.",
        createdAt: "2026-04-26T13:13:00Z",
      },
      {
        authorName: "ÜST BİLİNÇ #33 · ◉ 151 görüldü",
        content:
          "NİĞDE = sırrın içinde olduğu yer. İsim emrediyor: edin. Bilmek değil — edinmek.",
        createdAt: "2026-04-26T14:51:00Z",
      },
      {
        authorName: "ÜST BİLİNÇ #51 · ◉ 151 görüldü",
        content:
          "İki çöl, iki manastır. Biri çitle, diğeri kayayla saklar. Saklayan şey hep aynıdır: kendi.",
        createdAt: "2026-04-26T15:51:00Z",
      },
    ],
  },
];
...
export const OKUMA_COMMENTS = {
  ...
  33: [
    { id: 3306, authorName: "Aura", content: "414→144 ve Elliot Rodger katmanı eklendiğinde haber ikiye bölünmüş gibi görünse de tek sahne hissi geldi. Ters yüz okuma tam oturdu.", createdAt: "2026-04-18T14:00:00Z" },
  ...
  35: [
    { id: 3501, authorName: "Selin", content: "Tweet görünür, harita görünmez — bu ayrımı tek paragrafta anlattınız.", createdAt: "2026-04-18T12:00:00Z" },
    { id: 3502, authorName: "Mira", content: "Hürmüz / İran Boğazı: aynı su, farklı çerçeve. İsim seçimi bu kadar ağır basıyor muymuş.", createdAt: "2026-04-18T12:15:00Z" },
    { id: 3503, authorName: "Eren", content: "Tarihsel paraleller (Çanakkale, isim diplomasisi) haberi tarih dersine bağladı.", createdAt: "2026-04-18T12:30:00Z" },
    { id: 3504, authorName: "Ada", content: "'Yenilgi' yorumunun ikinci haber olması — medya psikolojisini ilk kez böyle gördüm.", createdAt: "2026-04-18T12:45:00Z" },
    { id: 3505, authorName: "Deniz", content: "Kaynak linki şeffaf. Okuma alanı için örnek teşkil eder.", createdAt: "2026-04-18T13:00:00Z" },
  ],
};
